...
ModelSave_path='finetune_model/UID2021_SOTA_IQA_Meta_EffV2AllFeatureStairMSFBHFFLinear_FineUIED_model.pt'
ResultSave_path='result/UID2021_SOTA_EffV2AllFeatureStairMSFBHFFLinear_UIED.txt'
DatasetPrePath = 'database/UIED/'
