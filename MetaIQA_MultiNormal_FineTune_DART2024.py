...
ModelSave_path='finetune_model/UID2021_SOTA_IQA_Meta_EffV2AllFeatureStairMSFBHFFLinear_FineDART_model.pt'
ResultSave_path='result/UID2021_SOTA_EffV2AllFeatureStairMSFBHFFLinear_DART.txt'
DatasetPrePath = 'database/DART2024/'
