...
ModelLoad_path='/home/user/Meta_End/opensource/pre_model/UID2021_SOTA_IQA_Meta_EffV2AllFeatureStairMSFBHFFLinear.pt'
ModelSave_path='/home/user/Meta_End/opensource/finetune_model/UID2021_SOTA_IQA_Meta_EffV2AllFeatureStairMSFBHFFLinear_FineDART_model.pt'
ResultSave_path='/home/user/Meta_End/opensource/result/UID2021_SOTA_EffV2AllFeatureStairMSFBHFFLinear_DART.txt'
DatasetPrePath = '/home/user/Database/DART2024'
#print('UID2021_SOTA')
...
class Net2(nn.Module):
    ...
    def forward(self, x1,x2):
        f1,f2 = self.headnet(x1,x2)
        output = self.net(f1,f2)
        return output
...
def computeSpearman(dataloader_valid, model):
    ...
    # 保存到csv文件
        #output_file = os.path.join(output_folder, 'output_DART2024.csv')
...
def load_data(mod = 'train',i=0):
    ...
    #traincsv_name="train_image" +str(i+1) +".csv"
    #testcsv_name="test_image" +str(i+1) + ".csv"
