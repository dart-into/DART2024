...
ModelSave_path='/home/user/Meta_End/opensource/finetune_model/UID2021_SOTA_IQA_Meta_EffV2AllFeatureStairMSFBHFFLinear_FineSAUD_model.pt' #save finetune
ResultSave_path='/home/user/Meta_End/opensource/result/UID2021_SOTA_EffV2AllFeatureStairMSFBHFFLinear_SAUD.txt' 
DatasetPrePath = '/home/user/Database/Enhanced'
#print('TID2013_KADID10K')
...
def computeSpearman(dataloader_valid, model):
    ...
    # 保存到csv文件
        #output_file = os.path.join(output_folder, 'output_SAUD.csv')
